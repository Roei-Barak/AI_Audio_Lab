...
Write-Host "[1/6] בודק Python..." -ForegroundColor Yellow
try {
...
Write-Host "[2/6] יוצר סביבה וירטואלית..." -ForegroundColor Yellow
...
# ── 3. Upgrade pip ────────────────────────────────────────────────────────────
Write-Host "[3/6] מעדכן pip..." -ForegroundColor Yellow
& $PipExe install --upgrade pip --quiet
Write-Host "  ✅ pip מעודכן" -ForegroundColor Green

# ── 4. Install base dependencies (no heavy ML yet) ───────────────────────────
Write-Host "[4/6] מתקין תלויות בסיס..." -ForegroundColor Yellow
$BaseDeps = @(
    "yt-dlp",
    "imageio-ffmpeg",
    "gradio>=4.0",
...
# ── 5. PyTorch ───────────────────────────────────────────────────────────────
if (-not $NoPyTorch) {
    Write-Host "[5/6] מתקין PyTorch..." -ForegroundColor Yellow
    ...
    Write-Host "[5/6] PyTorch — דולג (--NoPyTorch)" -ForegroundColor DarkGray
}

# ── 6. audio-separator ───────────────────────────────────────────────────────
Write-Host "[6/6] מתקין audio-separator..." -ForegroundColor Yellow
